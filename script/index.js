...
define("script/features/index", ["require", "exports", "script/features/fps", "script/features/clock"], function (require, exports, ImportedFps, ImportedClock) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/events", ["require", "exports", "script/library/index", "script/features/index", "script/ui", "script/url", "resource/config", "resource/control"], function (require, exports, _library_3, _features_1, ui_3, url_1, config_json_5, control_json_2) {
    ...
    (function (Events) {
        var updateFuseFps = function () {
            return _features_1.Features.Fps.fuseFps = parseFloat(ui_3.UI.fuseFpsSelect.get());
        };
        var updateShowFps = function () {
            ui_3.UI.fpsDisplay.classList.toggle("hide", !ui_3.UI.showFps.get());
        };
        var updateClock = function () {
            control_json_2.default.clock.enum.forEach(function (i) { return ui_3.UI.clockDisplay.classList.toggle(i, i === ui_3.UI.clockSelect.get()); });
        };
        ...
        Events.initialize = function () {
            ...
            ui_3.UI.playButton.data.click = function (event, button) {
            ...
            setTimeout(function () { return ui_3.UI.introductionPanel.classList.toggle("force-show", false); }, 15000);
            ui_3.UI.fuseFpsSelect.loadParameter(url_1.Url.params, applyParam).setChange(updateFuseFps);
            ...
            [
                ui_3.UI.colorspaceSelect,
                ui_3.UI.coloringSelect,
                ui_3.UI.patternSelect,
                ui_3.UI.canvasSizeSelect,
                ui_3.UI.layersSelect,
                ui_3.UI.spotslayersSelect,
                ui_3.UI.cycleSpanSelect,
                ui_3.UI.fuseFpsSelect,
                ui_3.UI.easingCheckbox,
                // UI.withFullscreen,
                ui_3.UI.showFps,
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                setTimeout(function () {
                    return [
                        ...
                        ui_3.UI.cycleSpanSelect,
                        ui_3.UI.fuseFpsSelect,
                        ui_3.UI.frameDelaySelect,
                        ui_3.UI.easingCheckbox,
                        ui_3.UI.withFullscreen,
                        ui_3.UI.showFps,
                        ui_3.UI.clockSelect,
                        ui_3.UI.brightnessSelect,
                        ui_3.UI.languageSelect,
                    ]
            ...
            window.addEventListener("languagechange", function () {
                ...
                _library_3.Library.Locale.setLocale(ui_3.UI.languageSelect.get());
