...
define("locale/generated/master", ["require", "exports"], function (require, exports) {
    ...
    exports.localeMaster = {
        ...
        "ur": {
            ...
            "remove-media": "میڈیا ہٹائیں",
            "loading-media": "میڈیا لوڈ ہو رہا ہے...",
            "Auto": "خودکار",
            "description": "ویب براؤزر میں چلنے والا میڈیا پلیئر",
            "control-panel": "کنٹرول پینل",
            "wakeup-timer-panel": "ویک اپ ٹائمر پینل",
            "volume-panel": "والیوم پینل",
            "settings-panel": "سیٹنگز پینل",
            "sleep-timer-panel": "سلیپ ٹائمر پینل",
            "transport-panel": "ٹرانسپورٹ پینل",
            "media-list": "میڈیا فہرست",
            "media-count": "میڈیا گنتی",
            "media-length": "میڈیا مدت",
            "with-fullscreen": "فل اسکرین کے ساتھ",
            "brightness": "روشنائی",
            "stretch": "توسیع",
            "padding": "پیڈنگ",
            "cross-fade": "کراس فیڈ",
            "cross-fade-transition": "کراس فیڈ ٹرانزیشن",
            "alpha": "الفا",
            "blur": "دھندلاپن",
            "wipe": "وائپ",
            "random": "تصادفی",
            "image-span": "تصویر دکھانے کا وقت",
            "loop-short-media": "مختصر میڈیا کو لوپ کریں",
            "visualizer": "ویژولائزر",
            "visualizer-simple": "سادہ",
            "visualizer-plane-frequency": "پلین فریکوئنسی",
            "visualizer-plane-waveform": "پلین ویوفارم",
            "visualizer-arc-frequency": "آرک فریکوئنسی",
            "visualizer-arc-waveform": "آرک ویوفارم",
            "visualizer-double-arc": "ڈبل آرک",
            "visualizer-stereo-arc-frequency": "اسٹیریو آرک فریکوئنسی",
            "visualizer-stereo-arc-waveform": "اسٹیریو آرک ویوفارم",
            "visualizer-stereo-double-arc": "اسٹیریو ڈبل آرک",
            "analog-clock": "اینالوگ گھڑی",
            "oversize": "بڑا سائز",
            "regular": "معمول",
            "half": "نصف",
            "petit": "چھوٹا",
            "analog-clock-slim": "سلِم",
            "24hours-hand": "24 گھنٹے کی سوئی",
            "date-hands": "تاریخ کی سوئیاں",
            "millisecond-hand": "ملی سیکنڈ کی سوئی",
            "overlay-style": "اوورلے سٹائل",
            "hide": "چھپائیں",
            "blend": "ملائیں",
            "white": "سفید",
            "black": "کالا",
            ...
            "alternate": "متبادل",
            "rainbow": "رینبو",
            "overlay-position": "اوورلے پوزیشن",
            "center": "وسط",
            ...
            "top-left": "اوپر بائیں",
            "rotate": "گھمائیں",
            "with-weather": "موسم کے ساتھ",
            "weather-location": "موسم کی جگہ",
            "ip-address": "IP پتہ (کم درستگی)",
            "geolocation": "جیو لوکیشن (زیادہ درستگی)",
            "with-clock": "گھڑی کے ساتھ",
            "with-date": "تاریخ کے ساتھ",
            "with-calendar": "کیلنڈر کے ساتھ",
            "with-visualizer": "ویژولائزر (اوورلے)",
            "show-fps": "FPS دکھائیں",
            ...
            "fade-in": "فیڈ اِن وقت",
            "sleep": "نیند ٹائمر",
            "fade-out": "فیڈ آؤٹ وقت",
            "timeUnitMs": "ملی سیکنڈ",
            "timeUnitS": "سیکنڈ",
            "timeUnitM": "منٹ",
            "timeUnitH": "گھنٹہ",
            "timeUnitD": "دن",
            ...
            "Play / Pause": "پلے / وقفہ",
            "Volume": "والیوم",
            "Mute / Unmute": "خاموش کریں / خاموشی ختم کریں",
            "Volume Up / Down": "والیوم اوپر / نیچے",
            "Settings": "سیٹنگز",
            "Seek": "پلے پوزیشن",
            "Seek Backward": "واپس جائیں",
            "Seek Forward": "آگے جائیں",
            "Go to Previous/Next Media": "پچھلے/اگلے میڈیا پر جائیں",
            "Go to Previous Media": "پچھلے میڈیا پر جائیں",
            "Go to Next Media": "اگلے میڈیا پر جائیں",
            "FullScreen": "فل اسکرین",
            "no-media-message": "براہ کرم میڈیا شامل کریں۔",
            "no-repeat-message": "براہ کرم ری پیٹ فعال کریں۔",
            "not-supported-media-message": "یہ میڈیا چلایا نہیں جا سکتا۔",
            "wakeup-timer-not-working": "اس ڈیوائس پر ویک اپ ٹائمر درست طریقے سے کام نہیں کر سکتا۔",
            "wakeup-timer-requires-active-page": "ویک اپ ٹائمر کے صحیح کام کے لیے ویب صفحہ فعال ہونا ضروری ہے۔",
            "noscript-message": "جاوا اسکرپٹ غیر فعال ہے۔ براہ کرم جاوا اسکرپٹ فعال کریں۔"
        },
        "vi": {
...
define("script/library/locale", ["require", "exports", "script/tools/array", "locale/generated/master"], function (require, exports, array_1, localeMaster) {
    ...
    (function (Locale) {
        ...
        Locale.getColonSuffix = function (l) { var _a; return ((_a = Locale.master[l !== null && l !== void 0 ? l : lang]["lang-colon-suffix"]) !== null && _a !== void 0 ? _a : ":"); };
...
define("script/ui", ["require", "exports", "script/tools/index", "script/library/index", "script/url", "resource/control", "resource/shortcuts"], function (require, exports, _tools_2, _library_2, url_1, control_json_1, shortcuts_json_2) {
    ...
    (function (UI) {
        ...
        var VisibilityApplier = /** @class */ (function () {
            function VisibilityApplier(element, options) {
                if (options === void 0) { options = {}; }
        ...
        (function (SettingsPanel) {
            ...
            SettingsPanel.imageSpanSelect = new _library_2.Library.Control.Select(control_json_1.default.imageSpan, {
            ...
            SettingsPanel.languageSelect = new _library_2.Library.Control.Select({
                ...
                makeLabel: function (i) { return "Auto" === i ?
                    ...
                    ("".concat(i).concat(_library_2.Library.Locale.getColonSuffix(), " ")
            ...
            SettingsPanel.buildAt = _library_2.Library.UI.getElementById("span", "build-at");
...
define("script/features/overlay", ["require", "exports", "script/library/index", "script/tools/index", "script/ui", "script/features/weather", "resource/config"], function (require, exports, library_1, tools_1, ui_4, weather_1, config_json_4) {
    ...
    (function (Overlay) {
        ...
        Overlay.getEnoughAngleFractionDigits = function () {
            ...
            var shortSide = Math.min(innerWidth, innerHeight) * devicePixelRatio;
            var circumference = Math.PI * shortSide;
            if (circumference <= 1) {
...
define("script/features/track", ["require", "exports", "script/tools/index", "script/library/index", "script/ui", "script/features/elementpool", "script/features/media", "script/features/analyser", "script/features/visualizer", "flounder.style.js/index", "resource/config"], function (require, exports, _tools_5, _library_6, ui_8, elementpool_1, media_2, analyser_2, visualizer_1, flounder_style_js_1, config_json_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Track = /** @class */ (function () {
        function Track(media, index) {
            ...
            this.getEnoughPatternFractionDigits = function () {
                var innerWidth = window.innerWidth, innerHeight = window.innerHeight, devicePixelRatio = window.devicePixelRatio;
            ...
            switch (media.category) {
                case "image":
                    ...
                    if (this.playerElement && media_2.Media.isPixelatedImage(media)) {
        ...
        Track.prototype.getImageDuration = function () {
            var _a;
            return (_a = _tools_5.Tools.Timespan.parse(ui_8.UI.SettingsPanel.imageSpanSelect.get())) !== null && _a !== void 0 ? _a : 0;
        };
        ...
        Track.prototype.setOpacity = function (rate) {
            ...
            if (this.visualElement) {
                _library_6.Library.UI.setStyle(this.visualElement, "opacity", "".concat(finalOpacity.toFixed(config_json_8.default.rendering.opacitiyFractionalDigits)));
            }
        };
...
define("script/features/player", ["require", "exports", "script/tools/index", "script/library/index", "script/features/fps", "script/features/overlay", "script/ui", "script/features/elementpool", "script/features/media", "script/features/history", "script/features/track", "script/features/timer", "resource/config"], function (require, exports, _tools_6, _library_7, fps_1, overlay_1, ui_9, elementpool_2, media_3, history_1, track_1, timer_1, config) {
    ...
    (function (Player) {
        ...
        (function (CrossFade) {
            ...
            CrossFade.getDuration = function () { var _a; return (_a = _tools_6.Tools.Timespan.parse(ui_9.UI.SettingsPanel.crossFadeSelect.get())) !== null && _a !== void 0 ? _a : 0; };
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, elementpool_2.ElementPool.makeSure({
                                image: (_a = media_3.Media.mediaList.find(function (m) { return "image" === m.category; })) !== null && _a !== void 0 ? _a : null,
                                audio: (_b = media_3.Media.mediaList.find(function (m) { return "audio" === m.category; })) !== null && _b !== void 0 ? _b : null,
                                video: (_c = media_3.Media.mediaList.find(function (m) { return "video" === m.category; })) !== null && _c !== void 0 ? _c : null,
                            })];
                    case 1:
                        hasMade = _d.sent();
                    ...
                    case 3:
                        ...
                        if (media_3.Media.mediaList.length <= 0) {
        ...
        Player.pause = function () {
            ...
            CrossFade.pause();
            var isResumable = 0 < media_3.Media.mediaList.length && null !== currentTrack;
        ...
        Player.getVolume = function (trackType) {
            return (ui_9.UI.volumeRange.get() / 100) * CrossFade.getProgress(trackType) * timer_1.Timer.getTimerFade();
        };
        ...
        Player.makeIndexText = function (track) {
            return "".concat((media_3.Media.mediaList.indexOf(track.media) + 1).toLocaleString(Player.locale), " / ").concat(media_3.Media.mediaList.length.toLocaleString(Player.locale));
        };
...
define("script/medialist", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "script/features/media", "script/ui", "script/progress", "resource/config"], function (require, exports, _tools_7, _library_9, _features_1, media_4, ui_11, progress_1, config_json_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (MediaList) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, media_4.Media.fileToEntry(file)];
                    case 1:
                        entry = _c.sent();
                        if (!(null !== entry)) return [3 /*break*/, 3];
                        console.log("✅ Valid media file:", file);
                        media_4.Media.mediaList.push(entry);
                    ...
                    case 2:
                        ...
                        console.log("📂 Media added:", media_4.Media.mediaList[media_4.Media.mediaList.length - 1]);
                        return [3 /*break*/, 4];
                    case 3:
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                ...
                                                index = media_4.Media.mediaList.indexOf(entry);
                                                if (!(0 <= index && index < media_4.Media.mediaList.length)) return [3 /*break*/, 2];
                                                console.log("🗑️ Removing media:", media_4.Media.mediaList[index]);
                                                URL.revokeObjectURL(media_4.Media.mediaList[index].url);
                                                media_4.Media.mediaList.splice(index, 1);
                                                MediaList.clearPlayState();
                                                MediaList.updateInformationDisplay();
                                                MediaList.updateNoMediaLabel();
        ...
        MediaList.makeMediaEntryDom = function (entry) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ix = media_4.Media.mediaList.indexOf(entry);
                        ...
                        return [4 /*yield*/, media_4.Media.makeThumbnailElement(entry)];
                    case 1:
                        _c = [
                            _e.sent(),
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        if (fromIndex !== null && fromIndex !== toIndex) {
                                            moved = media_4.Media.mediaList.splice(fromIndex, 1)[0];
                                            media_4.Media.mediaList.splice(toIndex, 0, moved);
                                            MediaList.clearPlayState();
                                        }
                                        return [4 /*yield*/, MediaList.updateMediaListDisplay()];
                                    case 1:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _i = 0, _a = media_4.Media.mediaList;
                        _d.label = 1;
                    case 1:
        ...
        MediaList.updateInformationDisplay = function () {
            var _a;
            _library_9.Library.UI.setTextContent(ui_11.UI.SettingsPanel.mediaCount, media_4.Media.mediaList.length.toLocaleString(MediaList.locale));
            var imageSpan = (_a = _tools_7.Tools.Timespan.parse(ui_11.UI.SettingsPanel.imageSpanSelect.get())) !== null && _a !== void 0 ? _a : 0;
            var totalDuration = media_4.Media.mediaList.reduce(function (sum, entry) { var _a; return sum + ((_a = entry.duration) !== null && _a !== void 0 ? _a : imageSpan); }, 0);
        ...
        MediaList.updateNoMediaLabel = function () {
            var hasNoMedia = ui_11.UI.wakeUpToggle.get() && media_4.Media.mediaList.length <= 0;
    ...
    (function (Events) {
        ...
        var dragover = function (event) {
            ...
            if (files && 0 < files.length) {
                var hasMedia = Array.from(files).some(function (file) { return media_5.Media.isMediaFile(file); });
                if (hasMedia) {
                    event.preventDefault();
...
define("script/index", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "resource/config", "resource/control", "resource/evil-commonjs.config", "resource/evil-timer.js.config", "resource/images", "script/url", "script/ui", "script/medialist", "script/events", "script/screenshot"], function (require, exports, _tools_9, _library_12, _features_3, config_json_11, control_json_3, evil_commonjs_config_json_1, evil_timer_js_config_json_1, images_json_1, url_5, ui_14, medialist_2, events_1, screenshot_1) {
    ...
    var buildAt = new Date(build.tick).toLocaleString(url_5.Url.params["locale"]);
    console.log("\uD83D\uDCE6 BUILD AT: ".concat(buildAt, " ( ").concat(_tools_9.Tools.Timespan.toHumanizedString(new Date().getTime() - build.tick, 1), " ").concat(_library_12.Library.Locale.map("ago"), " )"));
    console.log("\uD83D\uDCE6 Available modules: ".concat(Object.keys(modules).join(", ")));
    _library_12.Library.UI.setTextContent(ui_14.UI.SettingsPanel.buildAt, buildAt);
});
