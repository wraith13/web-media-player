...
define("script/features/elementpool", ["require", "exports", "script/library/index", "script/ui", "script/features/analyser"], function (require, exports, _library_4, ui_3, analyser_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/features/track", ["require", "exports", "script/tools/index", "script/library/index", "script/ui", "script/features/elementpool", "script/features/analyser", "script/features/visualizer", "resource/config"], function (require, exports, _tools_5, _library_6, ui_5, elementpool_1, analyser_2, visualizer_1, config_json_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Track = /** @class */ (function () {
        ...
        Track.prototype.fastForward = function () {
            this.diffSeek(config_json_4.default.player.fastFowardSpan);
        };
        Track.prototype.rewind = function () {
            this.diffSeek(-config_json_4.default.player.rewindSpan);
        };
...
define("script/features/player", ["require", "exports", "script/tools/index", "script/library/index", "script/features/fps", "script/features/clock", "script/ui", "script/features/elementpool", "script/features/media", "script/features/history", "script/features/track", "resource/config"], function (require, exports, _tools_6, _library_7, fps_1, clock_1, ui_6, elementpool_2, media_2, history_1, track_1, Config) {
    ...
    (function (Player) {
                ...
                switch (_d.label) {
                    case 0:
                        if (ui_6.UI.isScrolledToMediaListBottom()) {
                            ui_6.UI.mediaList.scrollTop = ui_6.UI.mediaList.scrollHeight - ((ui_6.UI.mediaList.clientHeight * 1.5) + ui_6.UI.addMediaButtonHeight);
        ...
        Player.pause = function () {
            ...
            CrossFade.pause();
            ui_6.UI.screenBody.classList.toggle("paused", 0 < media_2.Media.mediaList.length && null !== currentTrack);
        };
        ...
        Player.clear = function () {
            ...
            _library_7.Library.UI.setTextContent(ui_6.UI.mediaTime, "");
...
define("script/url", ["require", "exports", "resource/config"], function (require, exports, config_json_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Url = void 0;
    ...
    (function (Url) {
        ...
        Url.make = function (params) {
            var url = new URL(config_json_5.default.canonicalUrl || window.location.href);
...
define("script/events", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "script/features/media", "script/medialist", "script/ui", "script/url", "resource/config", "resource/control"], function (require, exports, _tools_8, _library_9, _features_2, media_4, medialist_1, ui_9, url_3, config_json_6, control_json_2) {
    ...
    (function (Events) {
        ...
        Events.mousemove = function () {
            return mouseMoveTimer.start(document.body, "mousemove", config_json_6.default.ui.mousemoveTimeout);
        };
        ...
        Events.initialize = function () {
            ...
            ui_9.UI.screenBody.addEventListener("click", function () { return document.body.classList.toggle("show-ui"); });
            ...
            ui_9.UI.mediaList.addEventListener("scroll", function () { return document.body.classList.toggle("show-paused-media", ui_9.UI.screenBody.classList.contains("paused") && ui_9.UI.isScrolledToMediaListBottom()); });
            ...
            ui_9.UI.shuffleButton.data.click = function (event, button) {
                ...
                button.dom.blur();
                ui_9.UI.shuffleButton.dom.classList.toggle("on");
                applyParam("shuffle", "".concat(ui_9.UI.shuffleButton.dom.classList.contains("on")));
            };
            ui_9.UI.repeatButton.data.click = function (event, button) {
                event === null || event === void 0 ? void 0 : event.stopPropagation();
                button.dom.blur();
                ui_9.UI.repeatButton.dom.classList.toggle("on");
                applyParam("repeat", "".concat(ui_9.UI.repeatButton.dom.classList.contains("on")));
            };
            ...
            (_c = ui_9.UI.volumeRange).options || (_c.options = {});
            ...
            (_d = ui_9.UI.withFullscreenCheckbox).options || (_d.options = {});
            ...
            (_g = ui_9.UI.imageSpanSelect).options || (_g.options = {});
