...
define("resource/config", [], {
    ...
    "weather": {
        "site": "wttr.in",
        "format": "%c 🌡️%t 💧%h 💨%w",
        "geoLocationInterval": "30m",
        "geoLocationRetryInterval": "5m",
        "retryInterval": "5m",
        "fahrenheitLocales": [
            "en-US",
            "en-BS",
...
define("script/features/location", ["require", "exports", "script/ui", "script/tools/index", "resource/config"], function (require, exports, ui_2, _tools_3, config_json_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Location) {
        ...
        Location.isExpired = function () {
            var _a;
            var now = Date.now();
            var geoLocationRetryInterval = (_a = _tools_3.Tools.Timespan.parse(config_json_2.default.weather.geoLocationInterval)) !== null && _a !== void 0 ? _a : (30 * 60 * 1000);
        ...
        Location.get = function () {
            ...
            if ("geolocation" === ui_2.UI.weatherLocationSelect.get()) {
                if (Location.isExpired()) {
                    var now = Date.now();
                    var geoLocationRetryInterval = (_a = _tools_3.Tools.Timespan.parse(config_json_2.default.weather.geoLocationRetryInterval)) !== null && _a !== void 0 ? _a : (5 * 60 * 1000);
                    if (lastRequestTimestamp + geoLocationRetryInterval < now) {
                        lastRequestTimestamp = Date.now();
                        Location.requestToGetGeolocation();
                    }
                }
                return coords;
            }
...
define("script/features/weather", ["require", "exports", "script/tools/index", "script/features/location", "resource/config"], function (require, exports, _tools_4, location_1, config_json_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Weather) {
        ...
        Weather.setLocation = function (newLocation) {
        ...
        Weather.get = function (lang, location) {
            var _a;
            if (location === void 0) { location = location_1.Location.get(); }
            if (Weather.isExpired()) {
                var now = Date.now();
                var retryInterval = (_a = _tools_4.Tools.Timespan.parse(config_json_3.default.weather.retryInterval)) !== null && _a !== void 0 ? _a : (5 * 60 * 1000);
...
define("script/features/overlay", ["require", "exports", "script/library/index", "script/tools/index", "script/ui", "script/features/weather", "resource/config"], function (require, exports, library_1, tools_1, ui_3, weather_1, config_json_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/features/visualizer", ["require", "exports", "script/library/index", "script/ui", "resource/config"], function (require, exports, _library_4, ui_4, config_json_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("script/features/history", ["require", "exports", "script/features/media", "script/tools/index", "script/ui", "resource/config"], function (require, exports, media_1, _tools_5, ui_6, Config) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            switch (media_1.Media.mediaList.length) {
                ...
                case 2:
                    return history.length < 2 ?
                        _tools_5.Tools.Random.makeInteger(media_1.Media.mediaList.length) :
                        (0 === history[_tools_5.Tools.Random.makeInteger(history.length)] ? 1 : 0);
                default:
                    ...
                    var forbidens_1 = _tools_5.Tools.Array.backSlice(history, Math.ceil(media_1.Media.mediaList.length * Config.history.shuffleForbiddenRate));
                    var canonicals = unplayedList.filter(function (i) { return !forbidens_1.includes(i); });
                    return canonicals[_tools_5.Tools.Random.makeInteger(canonicals.length)];
            }
        };
    })(History || (exports.History = History = {}));
});
define("script/features/track", ["require", "exports", "script/tools/index", "script/library/index", "script/ui", "script/features/elementpool", "script/features/analyser", "script/features/visualizer", "resource/config"], function (require, exports, _tools_6, _library_6, ui_7, elementpool_1, analyser_2, visualizer_1, config_json_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Track = /** @class */ (function () {
        ...
        Track.prototype.isMuteCondition = function (volume, rate, fade) {
            if (_tools_6.Tools.Environment.isSafari()) {
...
define("script/features/player", ["require", "exports", "script/tools/index", "script/library/index", "script/features/fps", "script/features/overlay", "script/ui", "script/features/elementpool", "script/features/media", "script/features/history", "script/features/track", "resource/config"], function (require, exports, _tools_7, _library_7, fps_1, overlay_1, ui_8, elementpool_2, media_2, history_1, track_1, Config) {
    ...
    (function (Player) {
        ...
        Player.makeTimeText = function (track) {
            return "".concat(_tools_7.Tools.Timespan.toMediaTimeString(track.getElapsedTime()), " / ").concat(_tools_7.Tools.Timespan.toMediaTimeString(track.getDuration()));
        };
...
define("script/url", ["require", "exports", "resource/config"], function (require, exports, config_json_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Url = void 0;
    ...
    (function (Url) {
        ...
        Url.make = function (params) {
            var url = new URL(config_json_8.default.canonicalUrl || window.location.href);
...
define("script/medialist", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "script/features/media", "script/ui", "script/progress"], function (require, exports, _tools_8, _library_8, _features_1, media_3, ui_10, progress_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (MediaList) {
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        _c = [
                            ...
                            { tag: "span", className: "size", text: _tools_8.Tools.Byte.toDisplayString(entry.size, 3), },
                            { tag: "span", className: "duration", text: null !== entry.duration ? _tools_8.Tools.Timespan.toMediaTimeString(entry.duration) : "", }
                        ];
        ...
        MediaList.updateInformationDisplay = function () {
            ...
            _library_8.Library.UI.setTextContent(ui_10.UI.mediaLength, _tools_8.Tools.Timespan.toMediaTimeString(totalDuration));
        };
...
define("script/events", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "script/features/media", "script/medialist", "script/ui", "script/url", "resource/config", "resource/control"], function (require, exports, _tools_9, _library_9, _features_2, media_4, medialist_1, ui_11, url_3, config_json_9, control_json_2) {
    ...
    (function (Events) {
        ...
        var isSeekingTimer = new _tools_9.Tools.Timer.ExtendableTimer(function () {
        ...
        Events.initialize = function () {
            ...
            ui_11.UI.volumeButton.data.click = function (event, button) {
                event === null || event === void 0 ? void 0 : event.stopPropagation();
                button.dom.blur();
                if (_tools_9.Tools.Environment.isSafari() && !_features_2.Features.Analyser.isSupported()) {
...
define("script/index", ["require", "exports", "script/tools/index", "script/library/index", "script/features/index", "resource/config", "resource/control", "resource/evil-commonjs.config", "resource/evil-timer.js.config", "resource/images", "resource/powered-by", "script/url", "script/ui", "script/medialist", "script/events", "script/screenshot"], function (require, exports, _tools_10, _library_11, _features_3, config_json_10, control_json_3, evil_commonjs_config_json_1, evil_timer_js_config_json_1, images_json_1, powered_by_json_2, url_4, ui_13, medialist_2, events_1, screenshot_1) {
    ...
    console.log("\uD83D\uDCE6 BUILD AT: ".concat(build.at, " ( ").concat(_tools_10.Tools.Timespan.toDisplayString(new Date().getTime() - build.tick, 1), " ").concat(_library_11.Library.Locale.map("ago"), " )"));
