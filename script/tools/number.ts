export namespace NumberTools
{
    ...
    export const toString = (value: number, maximumFractionDigits?: number, locales: Intl.LocalesArgument = "en-US") =>
        value.toLocaleString(locales, { useGrouping: false, maximumFractionDigits, });
