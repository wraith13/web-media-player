export namespace NumberTools
{
    ...
    export const toString = (value: number, maximumFractionDigits?: number, locales?: Intl.LocalesArgument) =>
        value.toLocaleString(locales ?? "en-US", { useGrouping: false, maximumFractionDigits, });
